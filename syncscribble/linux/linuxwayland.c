...
static void handleHardwareSerial(void*, struct zwp_tablet_tool_v2*, uint32_t, uint32_t)
{
}

static void handleHardwareIdWacom(void*, struct zwp_tablet_tool_v2*, uint32_t, uint32_t)
{
}
...
static void handlePadAdded(void *, struct zwp_tablet_seat_v2 *, struct zwp_tablet_pad_v2 *)
{
  // TODO
}
